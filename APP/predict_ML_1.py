...
def predict(file_path):
            ...
            scaler = pickle.load(open("/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/scalar.pkl", 'rb'))
            X_train = pickle.load(open("/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/xtrain.pkl", 'rb'))
            perm_features=pickle.load(open("/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/perm_features.pkl",'rb'))
            ...
            rfc = pickle.load(open('/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/Random forest.pkl', 'rb'))
            cbc = pickle.load(open('/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/CatBoost.pkl', 'rb'))
            xgbc = pickle.load(open('/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/XGBoost.pkl', 'rb'))
            gbc = pickle.load(open('/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/Gradient Boosting.pkl', 'rb'))
            abc = pickle.load(open('/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/AdaBoost.pkl', 'rb'))
            lr = pickle.load(open('/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/Logistic Regression.pkl', 'rb'))
            cls = pickle.load(open('/content/drive/MyDrive/projet_machine/ML/Machine_L/1 models train/KNN.pkl', 'rb'))
